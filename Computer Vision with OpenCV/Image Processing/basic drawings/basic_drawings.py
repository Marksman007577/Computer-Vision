...
def my_ellipse(img, angle):
    ...
    cv2.ellipse(img, (W // 2, W // 2), (W // 4, W // 16), angle, 0, 360, (255, 0, 0), thickness, line_type)


def filled_circle(img, center):
    thickness = -1
    line_type = 8
...
# To draw the atom, we used MyEllipse and MyFilledCircle:
...
filled_circle(atom_image, (W // 2, W // 2))

# 2. Draw a rook
# ------------------
# 2.a. Create a convex polygon
my_polygon(rook_image)
cv2.rectangle(rook_image, (0, 7 * W // 8), (W, W), (0, 255, 255), -1, 8)
...
cv2.imwrite("atom_image.png", atom_image)
cv2.imshow(rook_window, rook_image)
cv2.moveWindow(rook_window, W, 200)
cv2.imwrite("rook_image.png", rook_image)
